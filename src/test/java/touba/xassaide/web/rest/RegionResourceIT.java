...
import touba.xassaide.domain.Region;
import touba.xassaide.repository.RegionRepository;
...
class RegionResourceIT {
    ...
    public static Region createEntity(EntityManager em) {
        Region region = new Region().nom(DEFAULT_NOM);
        return region;
    }
    ...
    public static Region createUpdatedEntity(EntityManager em) {
        Region region = new Region().nom(UPDATED_NOM);
        return region;
    }
