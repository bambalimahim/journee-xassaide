...
export class CuisineComponent implements OnInit {
  ...
  trackId(index: number, item: ICuisine): number {
    return item.id!;
  }

  delete(cuisine: ICuisine): void {
    const modalRef = this.modalService.open(CuisineDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: ICuisine[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
