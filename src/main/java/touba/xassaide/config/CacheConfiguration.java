...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, touba.xassaide.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, touba.xassaide.repository.UserRepository.USERS_BY_EMAIL_CACHE);
